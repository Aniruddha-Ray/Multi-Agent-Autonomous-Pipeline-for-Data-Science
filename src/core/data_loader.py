...
Extracted verbatim from Notebook Cell 3 ("CELL 3 — DATASET UPLOAD"). Logic,
fallback order, and messages are unchanged from the notebook: prefer an
uploaded CSV, then a Colab interactive upload, then a synthetic fallback
dataset so the pipeline can always run end-to-end.
"""
